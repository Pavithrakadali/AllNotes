...
public class TextField_Validations {
    public static void main(String[] args) {
        ...
        try {
            ...
            //8. How many text fields exist? Enter the value in Third text field?
            oEles = ch.findElements(By.xpath("//input[@type='text' or @type='password']"));
            System.out.println("No. of text fields: " + oEles.size());
            oEles.get(2).sendKeys("xxxxxxxxxxxxxxxxxxxxxxxxxxxxx");
        }catch(Exception e){
            e.printStackTrace();
        }finally{
            oEle = null;
